...
const SESSION_DATA = {
  ...
  subtopics: ["Pathophysiology", "VEGF & Angiogenesis", "Macular Edema", "Clinical Staging"],
...
export function SummaryScreen() {
  ...
  useEffect(() => {
    const result = addXP(XP_REWARDS.sessionComplete);
      ...
      <div className="flex-1 max-w-5xl mx-auto w-full px-6 py-10 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-white font-semibold">{SESSION_DATA.topic}</span>.
          </motion.p>
        </motion.div>
